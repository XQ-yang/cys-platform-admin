<template>
  <div>
    <tinymce :height="300" v-model="content" id='tinymceId' ref="tinymce"></tinymce>
    <br/>
    <Button @click="changeContent">动态修改内容</Button>
  </div>
</template>
