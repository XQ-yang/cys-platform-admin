  ...
  <div>
    <Card>
      ...
      <div class="search-con search-con-top">
        ...
        <Button v-permission="{rule:'addOrganize'}" @click="handleCreate" class="search-btn">新增</Button>
      </div>
      <!--列表 分页-->
      ...
      cancel-text="关闭">
        <Form ref="deptForm" :model="deptTemp" :rules="rules" :label-width="100" style="padding-right:20px;">
          ...
          <Form-item label="排序值" prop="postionCode" :maxlength="5">
            <Input type="text" v-model="deptTemp.sort"></Input>
          </Form-item>
