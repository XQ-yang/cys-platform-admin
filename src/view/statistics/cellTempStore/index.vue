...
import { getCellTempStoreList, getHalfYearParams } from '@/api/statistics'
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns: [
        ...
        { title: '存储数量', key: 'cellQuantity', tooltip: true },
        { title: '液氮罐存储位置',
          key: 'pot_code',
          tooltip: true,
          minWidth: 240,
        ...
        { title: '存储人', key: 'storeUserName', tooltip: true }
      ],
      total: 0,
      tableLoading: false,
      loading: true,
  ...
  methods: {
    ...
    getList() {
      ...
      getCellTempStoreList(this.listQuery).then(res => {
